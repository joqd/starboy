        ...
        items: [
            {
                ...
                a: "درحال حاضر پرداخت آنلاین از ۳ درگاه مختلف امکان پذیر هست، در آینده امکان پرداخت اقساطی و کارت به کارت رو اضافه خواهیم کرد.",
            },
            {
        ...
        items: [
            {
                ...
                a: "زیر هر محصول، جدول سایز اختصاصی همون مدل نوشته شده.",
            },
        ],
    },
    {
        ...
        items: [
            {
                ...
                a: "معمولا ۳ تا ۷ روز کاری بسته به شهر مقصد. جزئیات کامل زمان‌بندی و هزینه‌ها رو در صفحه‌ی ارسال و مرجوعی می‌تونی ببینی.",
            },
            {
                q: "ارسال از طریق چه شرکتی انجام میشه؟",
                a: "در حال حاضر، از طریق شرکت تیپاکس.",
            },
            {
                q: "هزینه ارسال چقدر هست؟",
                a: "هزینه ارسال به صورت پسکرایه است و بستگی به شهر مقصد داره.",
            },
        ],
    },
    {
